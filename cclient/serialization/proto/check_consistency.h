...
retcode_t proto_check_consistency_serialize_response(check_consistency_res_t *const obj, char_buffer_t *out);
retcode_t proto_check_consistency_deserialize_request(const char *const obj, check_consistency_req_t *out);
