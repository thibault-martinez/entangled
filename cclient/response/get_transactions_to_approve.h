 ...
 */
static inline flex_trit_t const* const get_transactions_to_approve_res_branch(
 ...
 */
static inline flex_trit_t const* const get_transactions_to_approve_res_trunk(
    get_transactions_to_approve_res_t const* const res) {
  return res->trunk;
}
